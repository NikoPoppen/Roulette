...
public class ControllerMenu {
    ...
    void onLoginClick(ActionEvent event) {
    	System.out.println("Benutzername: " + username.getText() + "\nPasswort: " + password.getText());	//eingegebener text im textfeld "username" und "password" wird durch das klicken auf den "ok" knopf ausgelesen
